...
import { BeakerIcon, DevicePhoneMobileIcon, ShieldCheckIcon } from "@heroicons/react/24/solid";
const FEATURES = [
    {
        icon: DevicePhoneMobileIcon, // or ClipboardListIcon for an alternative option
        title: "Livestock Farmers",
        description: "Digital animal health and production tracking using mobile app.",
    },
    {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="col-span-2 flex flex-col justify-between">
            <div>
              ...
              <Typography className="mb-5 max-w-1/2 px-4 text-left text-lg !text-gray-700 lg:pr-32">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              {FEATURES.map(({ icon, title, description }) => (<FeatureCard key={title} icon={icon} title={title}>
                  {description}
                </FeatureCard>))}
            </div>
          </div>
