...
function Hero() {
    return (<div className="relative min-h-screen w-full">
      <header className="grid !min-h-[49rem] px-8 bg-cover bg-center bg-no-repeat relative" style={{
            backgroundImage: "url(/image/bg.png)",
            position: "relative",
        }}>
        {/* Dark overlay */}
        <div className="absolute inset-0 bg-black opacity-45" style={{ zIndex: 1 }}></div>
        {/* Content */}
        <div className="container mx-auto grid h-full w-full grid-cols-1 place-items-center lg:grid-cols-2 relative z-10">
          <div className="col-span-1">
            ...
            <Typography variant="h4" className="mb-7 !text-white md:pr-8 xl:pr-2 font-medium">
            ...
            <div className="flex flex-col gap-2 md:mb-2 md:w-10/12 md:flex-row">
              <Button size="lg" color="white" className="flex justify-center bg-green-700 text-white items-center gap-3">
                <Image width={256} height={256} src="/image/application.png" alt="metamask" className="w-6 h-6 text-white"/>
                Explore M-Vet
              </Button>
            </div>
          </div>
          <Image width={470} height={576} src="/image/iphones.png" alt="team work" className="col-span-1 my-20 h-full max-h-[30rem] -translate-y-32 md:max-h-[36rem] lg:my-0 lg:ml-auto lg:max-h-[40rem] lg:translate-y-0"/>
        </div>
      </header>
      ...
      <div className="mx-8 lg:mx-72 lg:mt-32 rounded-xl bg-white p-2 md:p-8 md:px-16 shadow-md relative z-10" style={{ marginTop: "-3rem" }}>
        <div>
          ...
          <Typography variant="paragraph" className="font-normal !text-gray-700 lg:w-full">
